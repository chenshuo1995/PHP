<?php 
    ...
    //根据user_id查询用户名
    $userId = $goods[0]['user_id'];
    $result = $pdo->query("select username from user where user_id={$userId} limit 1");
    ...
    <div class="section" style="margin-top:20px;">
        <div class="width1200">
            ...
            <div class="fl sec_intru_bg">
                <dl>
                    <dt><?php echo $goods[0]["goodsname"]?></dt>
                    <dd>
                        <p>发布人：<span><?php echo $user[0]["username"]; ?></span></p>
